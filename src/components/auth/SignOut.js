  ...
  return (
    <div className="ext-center">
      ...
      <button
        ...
        className="bg-[#5865F2] text-white hover:bg-[#4752C4] font-bold py-2 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50"
      >
        Sign Out
      </button>
    </div>
