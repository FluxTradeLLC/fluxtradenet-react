...
import { faDiscord, faYoutube, faTwitch, faInstagram, faFacebook, faTiktok } from '@fortawesome/free-brands-svg-icons';
  ...
  return (
    <header className="bg-gray-900 text-white p-4 sm:p-6 md:p-8">
      <div className="lg:flex lg:items-center lg:justify-between">
        <Link to="/" className="flex items-center justify-center flex-col md:flex-row lg:flex-shrink-0" onClick={handleClick}>
