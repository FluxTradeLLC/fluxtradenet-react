    ...
    return (
        <div className="bg-gray-900 text-white min-h-screen">
            <div className="text-center mb-12 pt-12">
                ...
                <p className="text-lg text-gray-400">Unlock the full potential of FluxTrade with our tailored plans. All plans offer a 30 day free trial!</p>
            </div>
            <div className="flex flex-col items-center">
                ...
                <div className='flex gap-6 flex-wrap md:flex-nowrap justify-center w-full'>
                    <div className="bg-gray-800 rounded-lg p-6 w-full max-w-sm border border-gray-700 transform hover:scale-105 transition-transform duration-300">
                        ...
                        {isAuthenticated ? (
                            <div className="grid grid-cols-2 gap-3">
                                <button onClick={() => handleCheckout(PRICING_IDS[envKey].STANDARD_SINGLE_NT)} className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-4 rounded-lg transition-colors duration-300">NinjaTrader</button>
                                <button onClick={() => handleCheckout(PRICING_IDS[envKey].STANDARD_SINGLE_TV)} className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-4 rounded-lg transition-colors duration-300">TradingView</button>
                            </div>
                        ) : (
                            <div className="grid grid-cols-2 gap-3">
                                <button onClick={() => navigate('/account')} className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-4 rounded-lg transition-colors duration-300">NinjaTrader</button>
                                <button onClick={() => navigate('/account')} className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-4 rounded-lg transition-colors duration-300">TradingView</button>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="bg-gray-800 rounded-lg p-6 w-full max-w-sm border border-gray-700 transform hover:scale-105 transition-transform duration-300">
                        <h2 className="text-2xl font-bold text-center mb-1">Indicators</h2>
                        <h3 className="text-center text-sm text-gray-400 mb-4">Both Platforms</h3>
                        <p className="text-center text-4xl font-extrabold mb-6">$69<span className="text-lg font-medium text-gray-400">/mo</span></p>
                        <ul className="space-y-4 text-gray-300 mb-8">
                            <li className="flex items-center">
                                <svg className="w-6 h-6 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>
                                <span>Access to all our indicators</span>
                        ...
                        {isAuthenticated ? (
                            <button onClick={() => handleCheckout(PRICING_IDS[envKey].STANDARD_BOTH)} className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300">Go To Checkout</button>
                        ) : (
                            <button onClick={() => navigate('/account')} className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300">Get Started</button>
                        )}
                    </div>
                </div>
                ...
                <div className='flex gap-6 mt-8 flex-wrap md:flex-nowrap justify-center w-full'>
                    ...
                    <div className="bg-gray-800 rounded-lg p-6 w-full max-w-sm border-2 border-indigo-500 transform hover:scale-105 transition-transform duration-300 relative">
                        ...
                        <h2 className="text-2xl font-bold text-center mb-1 text-indigo-400">Automated Strategies</h2>
                        <h3 className="text-center text-sm text-gray-400 mb-4">Single Platform</h3>
                        ...
                        {isAuthenticated ? (
                            <div className="grid grid-cols-2 gap-3">
                                <button onClick={() => handleCheckout(PRICING_IDS[envKey].PRO_SINGLE_NT)} className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-4 rounded-lg transition-colors duration-300">NinjaTrader</button>
                                <button onClick={() => handleCheckout(PRICING_IDS[envKey].PRO_SINGLE_TV)} className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-4 rounded-lg transition-colors duration-300">TradingView</button>
                            </div>
                        ) : (
                            <div className="grid grid-cols-2 gap-3">
                                <button onClick={() => navigate('/account')} className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-4 rounded-lg transition-colors duration-300">NinjaTrader</button>
                    ...
                    <div className="bg-gray-800 rounded-lg p-6 w-full max-w-sm border-2 border-indigo-500 transform hover:scale-105 transition-transform duration-300">
                        <h2 className="text-2xl font-bold text-center mb-1 text-indigo-400">Automated Strategies</h2>
                        <h3 className="text-center text-sm text-gray-400 mb-4">Both Platforms</h3>
                        <p className="text-center text-4xl font-extrabold mb-6">$119<span className="text-lg font-medium text-gray-400">/mo</span></p>
                        <ul className="space-y-4 text-gray-300 mb-8">
                            <li className="flex items-center">
                                <svg className="w-6 h-6 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>
                        ...
                        {isAuthenticated ? (
                            <button onClick={() => handleCheckout(PRICING_IDS[envKey].PRO_BOTH)} className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300">Go To Checkout</button>
                        ) : (
                            <button onClick={() => navigate('/account')} className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300">Get Started</button>
                        )}
                    </div>
