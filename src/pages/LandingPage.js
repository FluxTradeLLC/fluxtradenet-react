...
const getCsvFilename = (backtestUrl) => {
  ...
  const urlToCsvMap = {
    ...
    "bitcoin-rocket": "bitcoinRocket.csv",
    "daily-sweep": "dailySweep.csv",
    "delta-divergence": "deltaDivergence.csv",
    "evolving": "evolving.csv",
    "first-candle": "firstCandle.csv",
    "fvg": "fvg.csv",
    "hundo": "hundo.csv",
    "hyperscalp": "hyperscalp.csv",
    "order-flow-strat": "orderFlowStrat.csv",
    "ribbon-strat": "ribbonStrat.csv",
    "trapped-breakout": "trappedBreakout.csv",
  };
...
export function LandingPage() {
  ...
  const strategies = [
    ...
    {
      name: "Bitcoin Rocket",
      nameKey: "bitcoinRocket",
      images: [],
      features: [
        "Bitcoin/micro futures momentum strategy",
        "Trend following with defined targets",
        "ATR-based stops and position sizing",
      ],
      backtestUrl: "/backtests/bitcoin-rocket",
      categories: ["Trend", "Scalping"],
    },
    {
      name: "Daily Sweep",
      ...
      images: [],
      features: [
        "Sweep liquidity around daily swing levels",
        "Swing rejection long and short signals",
        "Quick scalps with tight risk",
      ],
      backtestUrl: "/backtests/daily-sweep",
      categories: ["Scalping"],
    },
    {
      name: "Delta Divergence",
      nameKey: "deltaDivergence",
      images: [],
      features: [
        "Delta divergence and exhaustion detection",
        "Bullish and bearish reversal signals",
        "Order flow based entries",
      ],
      backtestUrl: "/backtests/delta-divergence",
      categories: ["Mean Reversion"],
    },
    {
      name: "Evolving",
      ...
      images: [],
      features: [
        "Adaptive strategy that evolves with market",
        "Dynamic entry and exit logic",
        "Works across different market regimes",
      ],
      backtestUrl: "/backtests/evolving",
      categories: ["Trend"],
    },
    {
      name: "First Candle",
      ...
      images: [],
      features: [
        "Trades first candle of session structure",
        "Retest and breakout logic",
        "Quick scalps with defined targets",
      ],
      backtestUrl: "/backtests/first-candle",
      categories: ["Scalping"],
    },
    {
      ...
      images: [],
      features: [
        "Fair value gap detection and fills",
        "Long and short FVG entries",
        "ICT-style imbalance trading",
      ],
      backtestUrl: "/backtests/fvg",
      categories: ["Scalping", "Mean Reversion"],
    },
    {
      name: "Hundo",
      nameKey: "hundo",
      images: [],
      features: [
        "100-tick based strategy",
        "Scalps quick moves in direction",
        "Tight risk with fast targets",
      ],
      backtestUrl: "/backtests/hundo",
      categories: ["Scalping"],
    },
    {
      name: "Hyperscalp",
      ...
      features: [
        ...
        "EMA-based momentum entries",
        "One-bar profit targets",
      ],
      backtestUrl: "/backtests/hyperscalp",
      categories: ["Scalping"],
    },
    {
      name: "Order Flow Strat",
      nameKey: "orderFlowStrat",
      images: [],
      features: [
        "Order flow and volume analysis",
        "Long and short flow-based entries",
        "Volume-confirmed signals",
      ],
      backtestUrl: "/backtests/order-flow-strat",
      categories: ["Scalping", "Trend"],
    },
    {
      name: "Ribbon Strat",
      ...
      images: [],
      features: [
        "EMA ribbon alignment strategy",
        "Strong momentum continuation signals",
        "Quick profit targets on alignment",
      ],
      backtestUrl: "/backtests/ribbon-strat",
      categories: ["Trend", "Scalping"],
    },
    {
      name: "Trapped Breakout",
      nameKey: "trappedBreakout",
      images: [],
      features: [
        "Trapped buyers/sellers detection",
        "Reversal from failed breakouts",
        "High-probability counter-trend entries",
      ],
      backtestUrl: "/backtests/trapped-breakout",
